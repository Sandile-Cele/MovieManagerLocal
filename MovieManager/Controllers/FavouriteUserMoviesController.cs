...
using MovieManager.Models.MovieManagerModel;
...
namespace MovieManager.Controllers
{
    public class FavouriteUserMoviesController : Controller
    {
        ...
        public FavouriteUserMoviesController(MovieManagerContext context)
        {
            _context = context;
        }
        ...
        {
            var movieManagerContext = _context.FavouriteUserMovies.Include(f => f.User);
